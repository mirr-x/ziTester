...
{
    char *folder = "ex04";
    char *file = "ft_str_is_lowercase.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C02/ex04/tes_ft_str_is_lowercase.sh";
    char *path_file = "ex04/ft_str_is_lowercase.c";
    // not--------------------------------------------
