...
{
    char *folder = "ex05";
    char *file = "ft_str_is_uppercase.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C02/ex05/tes_ft_str_is_uppercase.sh";
    char *path_file = "ex05/ft_str_is_uppercase.c";
    // not--------------------------------------------
