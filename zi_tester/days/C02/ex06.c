...
{
    char *folder = "ex06";
    char *file = "ft_str_is_printable.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C02/ex06/tes_ft_str_is_printable.sh";
    char *path_file = "ex06/ft_str_is_printable.c";
    // not--------------------------------------------
