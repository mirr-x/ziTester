...
{
    char *folder = "ex11";
    char *file = "ft_putstr_non_printable.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C02/ex11/tes_ft_putstr_non_printable.sh";
    char *path_file = "ex11/ft_putstr_non_printable.c";
    // not--------------------------------------------
