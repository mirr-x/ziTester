...
{
    char *folder = "ex02";
    char *file = "ft_print_reverse_alphabet.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C00/ex02/tes_ft_print_reverse_alphabet.sh";
    char *path_file = "ex02/ft_print_reverse_alphabet.c";
    // not--------------------------------------------
