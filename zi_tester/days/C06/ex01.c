...
void z_C06_ex01(status_ex_dir *status_exr, int *pos_ptr)
{
    char *folder = "ex01";
    char *file = "ft_print_params.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C06/ex01/tes_ft_print_params.sh";
    char *path_file = "ex01/ft_print_params.c";
    // not--------------------------------------------
