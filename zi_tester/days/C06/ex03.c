...
void z_C06_ex03(status_ex_dir *status_exr, int *pos_ptr)
{
    char *folder = "ex03";
    char *file = "ft_sort_params.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C06/ex03/tes_ft_sort_params.sh";
    char *path_file = "ex03/ft_sort_params.c";
    // not--------------------------------------------
