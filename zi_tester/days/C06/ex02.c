...
void z_C06_ex02(status_ex_dir *status_exr, int *pos_ptr)
{
    char *folder = "ex02";
    char *file = "ft_rev_params.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C06/ex02/tes_ft_rev_params.sh";
    char *path_file = "ex02/ft_rev_params.c";
    // not--------------------------------------------
