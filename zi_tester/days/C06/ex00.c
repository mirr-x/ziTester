...
void z_C06_ex00(status_ex_dir *status_exr, int *pos_ptr)
{
    char *folder = "ex00";
    char *file = "ft_print_program_name.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C06/ex00/tes_ft_print_program_name.sh";
    char *path_file = "ex00/ft_print_program_name.c";
    // not--------------------------------------------
