...
{
    char *folder = "ex00";
    char *file = "ft_iterative_factorial.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C05/ex00/tes_ft_iterative_factorial.sh";
    char *path_file = "ex00/ft_iterative_factorial.c";
    // not--------------------------------------------
