...
{
    char *folder = "ex03";
    char *file = "ft_recursive_power.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C05/ex03/tes_ft_recursive_power.sh";
    char *path_file = "ex03/ft_recursive_power.c";
    // not--------------------------------------------
