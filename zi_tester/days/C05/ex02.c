...
{
    char *folder = "ex02";
    char *file = "ft_iterative_power.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C05/ex02/tes_ft_iterative_power.sh";
    char *path_file = "ex02/ft_iterative_power.c";
    // not--------------------------------------------
