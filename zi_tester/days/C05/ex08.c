...
{
    char *folder = "ex08";
    char *file = "ft_ten_queens_puzzle.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C05/ex08/tes_ft_ten_queens_puzzle.sh";
    char *path_file = "ex08/ft_ten_queens_puzzle.c";
    // not--------------------------------------------
