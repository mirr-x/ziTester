...
{
    char *folder = "ex01";
    char *file = "ft_recursive_factorial.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C05/ex01/tes_ft_recursive_factorial.sh";
    char *path_file = "ex01/ft_recursive_factorial.c";
    // not--------------------------------------------
