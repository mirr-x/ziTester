...
{
    char *folder = "ex07";
    char *file = "ft_find_next_prime.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C05/ex07/tes_ft_find_next_prime.sh";
    char *path_file = "ex07/ft_find_next_prime.c";
    // not--------------------------------------------
