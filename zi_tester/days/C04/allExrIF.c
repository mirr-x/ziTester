...
void z_test_C04_ex_folder(char *ex_folder, status_ex_dir *status_exr, int *pos_ptr)
{
    ...
    {
        z_C04_ex00(status_exr, pos_ptr);
    }
    else if (strcmp(ex_folder, "ex01") == 0)
    {
        z_C04_ex01(status_exr, pos_ptr);
    }
    else if (strcmp(ex_folder, "ex02") == 0)
    {
        z_C04_ex02(status_exr, pos_ptr);
    }
    else if (strcmp(ex_folder, "ex03") == 0)
    {
        z_C04_ex03(status_exr, pos_ptr);
    }
    else if (strcmp(ex_folder, "ex04") == 0)
    {
        z_C04_ex04(status_exr, pos_ptr);
    }
    else if (strcmp(ex_folder, "ex05") == 0)
    {
        z_C04_ex05(status_exr, pos_ptr);
    }
