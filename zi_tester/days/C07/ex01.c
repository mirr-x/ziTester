...
void z_C07_ex01(status_ex_dir *status_exr, int *pos_ptr)
{
    char *folder = "ex01";
    char *file = "ft_range.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C07/ex01/tes_ft_range.sh";
    char *path_file = "ex01/ft_range.c";
    // not--------------------------------------------
