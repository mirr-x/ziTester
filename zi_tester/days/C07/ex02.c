...
void z_C07_ex02(status_ex_dir *status_exr, int *pos_ptr)
{
    char *folder = "ex02";
    char *file = "ft_ultimate_range.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C07/ex02/tes_ft_ultimate_range.sh";
    char *path_file = "ex02/ft_ultimate_range.c";
    // not--------------------------------------------
