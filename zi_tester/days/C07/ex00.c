...
void z_C07_ex00(status_ex_dir *status_exr, int *pos_ptr)
{
    char *folder = "ex00";
    char *file = "ft_strdup.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C07/ex00/tes_ft_strdup.sh";
    char *path_file = "ex00/ft_strdup.c";
    // not--------------------------------------------
