...
void z_C07_ex03(status_ex_dir *status_exr, int *pos_ptr)
{
    char *folder = "ex03";
    char *file = "ft_strjoin.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C07/ex03/tes_ft_strjoin.sh";
    char *path_file = "ex03/ft_strjoin.c";
    // not--------------------------------------------
