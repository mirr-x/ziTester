...
void z_C07_ex05(status_ex_dir *status_exr, int *pos_ptr)
{
    char *folder = "ex05";
    char *file = "ft_split.c";
    char *sh_file = "/home/$USER/ziTester/testing_days_sh/C07/ex05/tes_ft_split.sh";
    char *path_file = "ex05/ft_split.c";
    // not--------------------------------------------
